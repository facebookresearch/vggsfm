...
from vggsfm.runners.interp_runner import InterpRunner
from vggsfm.datasets.demo_loader import DemoLoader
from vggsfm.utils.utils import seed_all_random_engines


@hydra.main(config_path="cfgs/", config_name="interp")
def demo_fn(cfg: DictConfig):
    """
    Main function to run the VGGSfM demo. InterpRunner is the main controller.

    InterpRunner assumes a sequential input of images.
    """
    ...
    vggsfm_runner = InterpRunner(cfg)
